...
// User-provided ASCII-art portrait of Dwight. Rendered not as text but as a
// luminance bitmap: each glyph maps to a green intensity by visual density
// (see charLevel() in Splash.cpp), producing a CRT-style portrait.
inline const char* DWIGHT_ASCII = R"DWIGHT(
                           `/+o/.
                       .+sso+/:oydyo/:-:+shdys/    `-:.     `-/+o+/`
